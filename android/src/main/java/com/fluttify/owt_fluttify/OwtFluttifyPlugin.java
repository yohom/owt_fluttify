...
import com.fluttify.owt_fluttify.sub_handler.*;
import com.fluttify.owt_fluttify.sub_handler.custom.SubHandlerCustom;

import static me.yohom.foundation_fluttify.FoundationFluttifyPluginKt.getEnableLog;
import static me.yohom.foundation_fluttify.FoundationFluttifyPluginKt.getHEAP;

@SuppressWarnings("ALL")
public class OwtFluttifyPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {

    private static List<Map<String, Handler>> handlerMapList;

    // v1 android embedding for compatible
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "com.fluttify/owt_fluttify");

        OwtFluttifyPlugin plugin = new OwtFluttifyPlugin();
        ...
        platformViewRegistry.registerViewFactory("com.fluttify/org.webrtc.SurfaceViewRenderer", new SurfaceViewRendererFactory(messenger, activity));
    }
    ...
    public void onAttachedToEngine(FlutterPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "OwtFluttifyPlugin::onAttachedToEngine@" + binding);
        }

        final MethodChannel channel = new MethodChannel(binding.getBinaryMessenger(), "com.fluttify/owt_fluttify");
    ...
    public void onDetachedFromEngine(FlutterPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "OwtFluttifyPlugin::onDetachedFromEngine@" + binding);
        }
    }
    ...
    public void onAttachedToActivity(ActivityPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "OwtFluttifyPlugin::onAttachedToActivity@" + binding);
        }
    ...
    public void onDetachedFromActivity() {
        if (getEnableLog()) {
            Log.d("fluttify-java", "OwtFluttifyPlugin::onDetachedFromActivity");
        }
    }
    ...
    public void onReattachedToActivityForConfigChanges(ActivityPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "OwtFluttifyPlugin::onReattachedToActivityForConfigChanges@" + binding);
        }
    }
    ...
    public void onDetachedFromActivityForConfigChanges() {
        if (getEnableLog()) {
            Log.d("fluttify-java", "OwtFluttifyPlugin::onDetachedFromActivityForConfigChanges");
        }
    }
